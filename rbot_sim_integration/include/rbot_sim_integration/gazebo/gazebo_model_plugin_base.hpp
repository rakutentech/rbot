#ifndef _RBOT_SIM_INTEGRATION_GAZEBO_GAZEBO_MODEL_PLUGIN_BASE_HPP_
#define _RBOT_SIM_INTEGRATION_GAZEBO_GAZEBO_MODEL_PLUGIN_BASE_HPP_
...
namespace gazebo {
/**
 * @class GazeboModelPluginBase
 * @brief Does a lot of boilerplate work for model plugins
 */
class GazeboModelPluginBase : public ModelPlugin
{
  public:
    /**
     * @ctor
     ...
     */
    GazeboModelPluginBase(const std::string pluginName_);
     ...
     * @param[in] parent_ base model for the plugin
     * @param[in] sdf_ data for the plugin in sdformat
     */
    void Load(physics::ModelPtr parent_, sdf::ElementPtr sdf_) override;
  ...
  protected:
    ...
    ///< parent model of the plugin
    physics::ModelPtr m_parentPtr;
...
#endif  // _RBOT_SIM_INTEGRATION_GAZEBO_GAZEBO_MODEL_PLUGIN_BASE_HPP_
